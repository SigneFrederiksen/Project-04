...
{
    public partial class ScienceFiction : System.Web.UI.Page
    {
        ...
        DataSet ds = null;
        DataTable dt = null;
        string sqlsel = "SELECT * From Movies Left Join Genre On Movies.GenreID = Genre.ID WHERE Genre LIKE '%science%' ORDER BY Title asc";
        ...
        public void ShowMovieData()
        {
            ...
            RepeaterSciFi.DataSource = pds;
            RepeaterSciFi.DataBind();
